...
//int globalSum = 0;
//
//// Thread safe queue(fixed size) implemented on std::queue
...
// *
// * Emptiness check is implemented in ThreadSafeFixedSizeQueue::pop() function
// * So we could be sure that pop() function will always return true
// * So there is no need in tracking number of pop operations
// */
//void consumer() {
//	int localSum = 0;
//	uint8_t elem;
//	for (int i = 0; i < TaskNum / ConsumerNum; i++) {
//		if (staticQueue.pop(elem))
//			localSum += elem;
//	}
//	globalSum += localSum;
//}
